...
const WelcomePage = ({ player1Name, player2Name, setPlayer1Name,
	setPlayer2Name, submitPlayerNames, sendGameMode,
	sendGameType, singlePlayer, setSinglePlayer }) => {
	...
	if (renderGameTypes) {
		return <SelectGameType sendGameType={sendGameType}
			setRenderGameTypes={setRenderGameTypes} />
	}
	if (renderGameModes) {
		return <SelectGameMode sendGameMode={sendGameMode}
			setRenderGameModes={setRenderGameModes}
